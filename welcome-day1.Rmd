...
.small[
- From Bookstore: If we were to process the backordered online orders normally, it would take days. So we will [improvise!]
- If you **have an existing online order**, 
  - Go to a register or to the pickup window to pick up your reader. 
  - You will need your order number. 
- If you **do not have an online order** , 
 - Go into the book area and grab a copy. 
 - Take to register.
]
---
## I Corinthians 8:1-3
...
.smaller[*Thanks to: Profs Baker, Bruxvoort, VanAntwerp, Dykstra-Pruim, Wunder*]
---

1.	What surprised you the first time you watched the scenario?
2.	Who did you identify with most the first time you watched the scenario?
3.	What other character(s) did you feel prompted to pay attention to in the scenario? What do you think they felt or experienced?

---
.small[
4.	What stood out to you when you listened to the student responses?
5.	Let’s think about different ways people could react to this situation. You can imagine how an instructor could respond. You could think about how you would respond as a classmate.  What would be an unhelpful way forward from this scenario? Come up with 2 unhelpful responses: one that is obviously unhelpful, one that is subtly unhelpful.
6.	Sometimes in the moment we don’t respond in helpful ways because we aren’t sure what to do. Take a moment to imagine a better or more helpful way forward for this type of situation.  What might that look like?  Why do you like your idea?
